...
for annotation in annotations:
    ...
    for box in boxes:
        ...
        for i in range(5):
            ...
            print(w)
            delta_x = np.random.randint(int(max(-size, -x1)), w)
            delta_y = np.random.randint(int(max(-size, -y1)), h)
        ...
        for i in range(20):
            ...
            delta_x = np.random.randint(int(-w * 0.2), int(w * 0.2)+5)
            delta_y = np.random.randint(-h * 0.2, h * 0.2+1)
